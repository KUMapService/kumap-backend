...
def main():
    parser = argparse.ArgumentParser(description="Generate region data (centroid or cadastral).")
    parser.add_argument('--centroid', action='store_true', help='Insert region centroid coordinates')
    parser.add_argument('--cadastral', action='store_true', help='Insert cadastral data')
    ...
    # if no flags are set, run all tasks by default.
    if not args.centroid and not args.cadastral:
        insert_region_coordinates(conn)
        insert_cadastral_data(conn)
